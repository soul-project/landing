...
Since we're an identity provider without any ties to a full social media platform,
we're impartial towards what you post or do in the different platforms integrating with Soul.
Getting banned or excluded from one platform does not mean you'll lose access to your Soul account
or other platforms.
